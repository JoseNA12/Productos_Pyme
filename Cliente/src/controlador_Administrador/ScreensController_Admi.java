...
public class ScreensController_Admi extends StackPane {

	private HashMap<String, Node> screens = new HashMap<>();

	public ScreensController_Admi(){
		super();
	}
	...
	public boolean loadScreen(String name, String resource){
		try{
			...
			ControlledScreen_Admi myScreenController = ((ControlledScreen_Admi) myLoader.getController());
