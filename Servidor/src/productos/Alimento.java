...
public class Alimento implements Serializable {
	...
	public int cantidad; //Top 10


	public Alimento(String pCodigo, String pNombre, String pDescripcion, String pTamanioPorcion, String pPiezasPorPorcion,
		...
		setCaloriasUnaPorcion(pCaloriasPorPorcion);
	...
	private void setTamanioPorcion(String tamanioPorcion) {
	...
	public String getCaloriasUnaPorcion() {
		return CaloriasPorPorcion;
	}
	private void setCaloriasUnaPorcion(String caloriasUnaPorcion) {
		CaloriasPorPorcion = caloriasUnaPorcion;
	}
	public String getCaloriasPorPieza() {
		return CaloriasPorPieza;
	}
	private void setCaloriasPorPieza(String caloriasPorPieza) {
